...
CareerUI.pages.market=async(route,host,active)=>{
 ...
 if(c.exists&&!c.over&&(route.source==='personal'||c.player_only||c.unsigned))return ui.personalTransferPage(route,host,active);
 ...
 host.innerHTML=ui.head('转会市场',`俱乐部资金 ${money(c.money)} · 保签不受队伍排名限制`)+ui.tabs([['free','自由球员'],['active','现役买断'],['academy','青训观察'],['personal','我的转会']],source)+
